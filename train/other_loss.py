...
class IBLoss(nn.Module):
    def __init__(self, weight=None, num_classes=None, alpha=10000.0):
    ...
    def forward(self, input, target, features):
        ...
        return ib_loss(
            F.cross_entropy(input, target, reduction="none", weight=self.weight), ib
        )
...
class IB_FocalLoss(nn.Module):
    def __init__(self, weight=None, num_classes=0, alpha=10000.0, gamma=0.0):
